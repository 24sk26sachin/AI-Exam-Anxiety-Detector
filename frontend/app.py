...
from backend.model_utils import get_predictor
        ...
        with st.spinner("Analyzing your thoughts..."):
            try:
                ...
                if "Low" in level:
                    ...
                    css_class = "very-high-anxiety"
                    emoji = "🆘"
                    tips = [
                        "Please seek immediate support or talk to someone you trust.",
                        "Your well-being is the top priority, exams come second.",
                        "Call a helpline or contact a counselor if you feel overwhelmed.",
                        "Step away from the study material and focus on your mental health."
                    ]
                else:
